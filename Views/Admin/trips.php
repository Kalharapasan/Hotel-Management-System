...
<body class="bg-slate-50 min-h-screen flex">
    <aside class="w-64 bg-slate-900 text-white flex flex-col hidden md:flex">
        ...
        <nav class="flex-1 px-4 space-y-2">
            ...
            <a href="<?php echo BASE_URL; ?>/admin/trips" class="flex items-center px-4 py-3 bg-indigo-600 rounded-xl">Trips</a>
        ...
        <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm mb-8">
            ...
            <form action="<?php echo BASE_URL; ?>/admin/save-trip" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 flex gap-4">
                    ...
                    <?php if($edit_trip): ?>
                        <a href="<?php echo BASE_URL; ?>/admin/trips" class="bg-slate-200 text-slate-700 px-8 py-3 rounded-xl font-bold hover:bg-slate-300 transition">Cancel</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo asset_url($trip['image_url']); ?>" class="w-10 h-10 rounded-lg object-cover" alt="">
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="<?php echo BASE_URL; ?>/admin/trips?edit=<?php echo $trip['id']; ?>" class="text-indigo-600 hover:text-indigo-800 font-bold mr-4">Edit</a>
                            <a href="<?php echo BASE_URL; ?>/admin/delete-trip?id=<?php echo $trip['id']; ?>" onclick="return confirm('Are you sure?')" class="text-red-500 hover:text-red-700 font-bold">Delete</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
