            ...
            <div class="grid">
                <?php if(isset($hotels)): ?>
                    <?php while($hotel = $hotels->fetch_assoc()): ?>
                        <div class="card">
                            <img src="<?php echo htmlspecialchars(asset($hotel['image_url'])); ?>" alt="<?php echo htmlspecialchars($hotel['name']); ?>">
                            <h3><?php echo htmlspecialchars($hotel['name']); ?></h3>
                            <p><?php echo htmlspecialchars($hotel['location']); ?></p>
                            <p class="price">$<?php echo number_format($hotel['price_per_night'], 2); ?>/night</p>
                            <a href="<?php echo BASE_URL; ?>/rooms" class="btn btn-secondary">View Rooms</a>
                        </div>
                    <?php endwhile; ?>
                <?php endif; ?>
            </div>
