    ...
    <nav class="bg-white border-b border-slate-100 py-4 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 flex justify-between items-center">
            ...
            <div class="flex gap-8 items-center">
                ...
                <a href="/restaurant" class="text-slate-600 font-medium">Restaurant</a>
                <a href="/profile" class="bg-indigo-600 text-white px-5 py-2 rounded-full font-bold shadow-lg shadow-indigo-100">My Account</a>
            </div>
        </div>
    </nav>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-[40px] overflow-hidden border border-slate-100 shadow-sm hover:shadow-2xl transition duration-500 group">
                <div class="relative h-72">
                    <img src="<?php echo $room['image_url']; ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-700" alt="">
                ...
                <div class="p-8">
                    ...
                    <form action="/rooms/book" method="GET" class="space-y-4">
